angular.module('WeatherApp.controllers.EventCustomer',[])
.controller('EventCustomerCtrl', function ($scope, $rootScope, EventService, $routeParams,  $location,SharedState) {
  SharedState.initialize($scope, 'modal1');
    ...
    $scope.loadRemoteData = function () {
      ...
      EventService.getProbableEvents()
        .then(
        function (events) {
